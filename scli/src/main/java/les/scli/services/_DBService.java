...
public class _DBService {
    ...
    public void instantiateTestDatabase() throws ParseException, IOException {
        ...
        Cliente cli1 = new Cliente(null, "Nome1", "12345678912", "email@gmail.com", "123", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");
        Cliente cli2 = new Cliente(null, "Nome2", "12345678912", "email@gmail.com", "123", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");
        ...
        Gerente ger1 = new Gerente(null, "Nome1", "12345678912", "email@gmail.com", "123", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");
        Gerente ger2 = new Gerente(null, "Nome2", "12345678912", "email@gmail.com", "123", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");

        Funcionario fun1 = new Funcionario(null, "Nome1", "12345678912", "email@gmail.com", "123", "ES", "Pequia",
                "Centro", "Rua Gustavo Lima");
        Funcionario fun2 = new Funcionario(null, "Nome2", "12345678912", "email@gmail.com", "123", "ES", "Pequia",
                "Centro", "Rua Gustavo Lima");

        EmpresaTerceirizada emp1 = new EmpresaTerceirizada(null, "Nome1", "12345678912345", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");
        EmpresaTerceirizada emp2 = new EmpresaTerceirizada(null, "Nome2", "12345678912345", "ES", "Pequia", "Centro",
                "Rua Gustavo Lima");

        Orcamento orc1 = new Orcamento(null, sdf.parse("2022-01-01"), sdf.parse("2022-01-01"), "Descricao1", 10.00,
                cli1, fun1);
        ...
        RealizarServicoFuncionario rsf1 = new RealizarServicoFuncionario(null, sdf.parse("2022-01-01"), false, false,
                ser1, fun1);
        RealizarServicoFuncionario rsf2 = new RealizarServicoFuncionario(null, sdf.parse("2022-01-01"), false, false,
                ser2, fun2);

        RealizarServicoEmpresa rse1 = new RealizarServicoEmpresa(null, sdf.parse("2022-01-01"), false, false, false,
                ser1, emp1);
        RealizarServicoEmpresa rse2 = new RealizarServicoEmpresa(null, sdf.parse("2022-01-01"), false, false, false,
                ser2, emp2);
