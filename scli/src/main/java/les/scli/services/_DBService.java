...
public class _DBService {
    ...
    public void instantiateTestDatabase() throws ParseException, IOException {
        ...
        RealizarServicoEmpresa rse1 = new RealizarServicoEmpresa(null, sdf.parse("2022-01-01"), false, ser1, emp1);
        RealizarServicoEmpresa rse2 = new RealizarServicoEmpresa(null, sdf.parse("2022-01-01"), false, ser2, emp2);
