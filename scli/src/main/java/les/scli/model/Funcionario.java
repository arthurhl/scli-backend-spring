...
public class Funcionario implements Serializable {
	...
	@Column(length = 50)
	@NotBlank(message = "Nome do Funcionario deve ser preenchido")
	private String nome;

	@Column(length = 50)
    @NotBlank(message = "CPF do Funcionario deve ser preenchido")
    @Size(min = 2, max = 50, message = "CPF do Funcionario deve ter entre 2 e 50 letras")
	private String cpf;
